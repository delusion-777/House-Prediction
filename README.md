...
- First, the data set is checked for any missing or null values. If there's any, then they are either dropped or replaced with the mean or median as per the analysis.
